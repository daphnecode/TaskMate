...
List<Task> repeatTaskList = [
  Task(text: '아침에 커피 한잔 마시기', isChecked: false, point: 0),
  Task(text: 'Running 3km', isChecked: false, point: 0),
  Task(text: '할 일을 추가해보세요', isChecked: false, point: 0),
  Task(text: '명상 30분', isChecked: false, point: 0),
  Task(text: 'run 3km', isChecked: false, point: 0),
  Task(text: '기상 후 스트레칭', isChecked: false, point: 0),
];
